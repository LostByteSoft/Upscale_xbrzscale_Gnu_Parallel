...
echo -------------------------========================-------------------------
	...
	echo    "${red}	█████████████████████   FATAL ERROR  █████████████████████ ${reset}"
	echo
echo -------------------------========================-------------------------
	echo Version compiled on : Also serves as a version
	echo 2022-11-23_Wednesday_02:24:05
	echo
...
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
	echo Delete /dev/shm/findimage.txt
	rm "/dev/shm/findimage.txt" 2> /dev/null
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	find "$file" -maxdepth 1 -name '*.avif'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.bmp'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.gif'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.jpeg'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.jpg'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.jpg_large'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.png'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.tif'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.tiff'  >> "/dev/shm/findimage.txt"
	find "$file" -maxdepth 1 -name '*.webp'  >> "/dev/shm/findimage.txt"
	
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
	echo Finding finish, with file count :
	lines=$(wc -l < "/dev/shm/findimage.txt")
	echo $lines
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	#echo parallel -a "/dev/shm/findimage.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.webp
	#parallel -a "/dev/shm/findimage.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.webp
	echo parallel -a "/dev/shm/findimage.txt" -j $entry xbrzscale $entry2 {} {.}_UpScale.jpg
	parallel -a "/dev/shm/findimage.txt" -j $entry xbrzscale $entry2 {} {.}_UpScale.jpg
	echo UpScale finish...
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	#then
		...
		echo "-------------------------===== Section $part =====-------------------------"
			...
			echo "find "$file" -maxdepth 1 -iname 'UpScale'  >> "/dev/shm/findimage.txt""
			## find "/$HOME/Desktop" -maxdepth 1 -iname '*UpScale.webp'  >> "/dev/shm/findimage.txt"
			#find "$file" -maxdepth 1 -iname '*UpScale.webp'  >> "/dev/shm/findimage.txt"	## webp
			find "$file" -maxdepth 1 -iname '*UpScale.jpg'  >> "/dev/shm/findimage.txt"		## jpg
			#cat "/dev/shm/findimage.txt"
			echo Finding finish, with file count :
			lines=$(wc -l < "/dev/shm/findimage.txt")
			echo $lines
			echo
		...
		echo "-------------------------===== Section $part =====-------------------------"
			...
			echo
			#parallel -a "/dev/shm/findimage.txt" -j $defi mogrify -define webp:lossless=true -format webp	## webp lossy
			#parallel -a "/dev/shm/findimage.txt" -j $defi mogrify -depth 32 -format webp	## webp
			parallel -a "/dev/shm/findimage.txt" -j $defi mogrify -format jpg -resize 95%	## jpg
			rm "/dev/shm/findimage.txt" 2> /dev/null
