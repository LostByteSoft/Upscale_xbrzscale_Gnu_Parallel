...
echo -------------------------========================-------------------------
	...
	echo 2022-11-10_Thursday_06:06:21
	echo
...
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
echo Gif finder... UpScale of animated gif are not supported.
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	then
		...
		echo "-------------------------===== Section $part =====-------------------------"
			...
			#parallel -a "/dev/shm/findparallel.txt" -j $defi mogrify -format jpg -quality 100	## jpg
			error $?
