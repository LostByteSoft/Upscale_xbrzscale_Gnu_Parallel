...
echo -------------------------========================-------------------------
	...
	echo 2023-03-21_Tuesday_02:34:05
	echo
...
echo "Select folder or filename using dialog !"
	echo
	file="$(zenity --file-selection --file-filter="*.jpg *.gif *.jpeg *.webp" --filename=$HOME/ --title="Select a file, all format supported")"	## File select.
