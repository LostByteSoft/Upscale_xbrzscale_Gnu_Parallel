...
echo -------------------------========================-------------------------
	...
	echo 2022-11-10_Thursday_04:53:58
	echo
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	then
		...
		## REconvert to jpg
		#echo convert "$name"_UpScale.jpg"" -format jpg -quality 100 "$name"_UpScale.jpg""
		#mogrify "$name"_UpScale.jpg"" -format jpg -quality 100 "$name"_UpScale.jpg""
		#error $?
